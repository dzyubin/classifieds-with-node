(function () {
    ...
    angular
        ...
        ['$rootScope', '$scope', 'ClassifiedsDB',
            function ($rootScope, $scope, ClassifiedsDB) {
                ...
                $scope.ClassifiedsDBService.nextPage()
                    .success(function () {
                        //$rootScope.classifieds = $rootScope.classifieds.splice(0, 4);
                        data = $rootScope.classifieds.map(function (obj) {
                            console.log(obj.created);
                            var mappedObj = {};
                            var date = new Date(obj.created);
                            console.log(obj.created.split('T')[0]);
