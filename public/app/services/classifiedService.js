angular.module('classifiedService', [])
    ...
    .factory('Classified', ['$rootScope', '$http', '$timeout', 'Auth', function ($rootScope, $http, $timeout, Auth) {
        ...
        classifiedFactory.getClassifieds = function () {
            ...
            $rootScope.getData = function(pageNumber){ // This would fetch the data on page change.
                ...
                $timeout(function () {
                    ...
                    if (Auth.isLoggedIn()){
                        ...
                        //console.log(userId);
                        classifiedsDataRoute = "/api/list/" + $rootScope.itemsPerPage + "/" + $rootScope.pageNumber + "/" + userId;
                        //console.log(classifiedsDataRoute);
                    } else {
                        classifiedsDataRoute = "/api/list/" + $rootScope.itemsPerPage + "/" + $rootScope.pageNumber;
                        //console.log(classifiedsDataRoute);
                    }
            ...
            $rootScope.getData($rootScope.pageNumber); // Call the function to fetch initial data on page load.
        };
